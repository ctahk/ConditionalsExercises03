...
// Code 5a - 5f here:
if (fuelLevel < 1000 || engineTemperature > 2500 || engineIndicatorLight){
...
if (commandOverride === true){
  console.log("Shuttle OK to launch.");
} else if (!commandOverride && fuelLevel >= 20000 && engineTemperature <= 2500 ) {
  console.log("Shuttle OK to launch.");
}
